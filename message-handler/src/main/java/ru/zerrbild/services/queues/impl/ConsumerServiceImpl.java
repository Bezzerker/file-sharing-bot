...
public class ConsumerServiceImpl implements ConsumerService {
    ...
    @Override
    @RabbitListener(queues = "${rabbitmq.exchanges.message.queues.text.name}")
    ...
    @Override
    @RabbitListener(queues = "${rabbitmq.exchanges.message.queues.document.name}")
    ...
    @Override
    @RabbitListener(queues = "${rabbitmq.exchanges.message.queues.image.name}")
    ...
    @Override
    @RabbitListener(queues = "${rabbitmq.exchanges.user.queues.deregister_candidates.name}")
